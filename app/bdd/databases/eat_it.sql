...
--
-- Host: 127.0.0.1    Database: eat_it
-- ------------------------------------------------------
...
CREATE TABLE `OrderFood` (
  ...
  `qte` varchar(45) NOT NULL DEFAULT '0',
  `prix` varchar(45) NOT NULL DEFAULT '0',
  `reduction` varchar(45) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
...
-- Dump completed on 2019-08-19 15:18:47
